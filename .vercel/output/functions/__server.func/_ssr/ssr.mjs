...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B552kCHM.mjs");
...
var manifest = {
	"16284a7454792051e968f6fad0c66c256d4c1b7a65e6e54cd31a0094c56b3912": {
		functionName: "saveSharedDecision_createServerFn_handler",
		importer: () => import("./shared-decisions-Dn4OCM7S.mjs")
	},
	"4fbd5c3253bea5dd3855ea3c3d7ee5182a6a0e392c0c06fc2750881c699732f1": {
		functionName: "listSharedDecisions_createServerFn_handler",
		importer: () => import("./shared-decisions-Dn4OCM7S.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-O69gteUd.mjs").then((n) => n.t),
