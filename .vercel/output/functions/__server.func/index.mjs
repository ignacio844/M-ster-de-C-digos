...
var grokOgIdentity = { "site": {
	"title": "Cruce BAMinds",
	"card": "custom",
	"description": "Compará cómo otras bases nombran los códigos respecto del catálogo BAMinds.",
	"image": "/og.jpg"
} };
//#endregion
...
var _lazy_1zvpqm = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_1zvpqm
	};
	return ((_m, p) => {
		return {
			data,
